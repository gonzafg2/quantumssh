...
- **Status:** Accepted; §Decision's opening sentence (provider and model), its permissions bullet and the "sent to DeepSeek" clause of its `No share` bullet are superseded by [ADR-0032](0032-opencode-reviewer-provider-model-variable-and-proof-of-review.md)
- **Date:** 2026-06-13
